...
*@FileName : INTGVO.java
*@FileTitle : INTGVO
*Open Issues :
*Change history :
*@LastModifyDate : 2022.04.22
*@LastModifier : 
*@LastVersion : 1.0
* 2022.04.22  
* 1.0 Creation
...
package com.clt.apps.opus.esm.clv.doutraining.practice2.vo.Condition;
...
public class INTGVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<INTGVO> models = new ArrayList<INTGVO>();
	...
	public INTGVO(String ibflag, String pagerows, String intgCdId, String intgCdValCtnt, String intgCdValDpDesc, String intgCdValDesc, String intgCdValDpSeq, String aplyStDt, String aplyEndDt) {
...
/**
	 ...
	 * @return INTGVO[]
	 */
	public INTGVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return INTGVO[]
	 */
	public INTGVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		INTGVO model = null;
	...
	public INTGVO[] getINTGVOs(){
		INTGVO[] vos = (INTGVO[])models.toArray(new INTGVO[models.size()]);
		return vos;
	}
