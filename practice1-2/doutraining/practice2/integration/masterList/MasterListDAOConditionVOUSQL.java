...
*@FileName : MasterListDAOConditionVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MasterListDAOConditionVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MasterListDAOConditionVOUSQL(){
		setQuery();
		...
		query.append("FileName : MasterListDAOConditionVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
