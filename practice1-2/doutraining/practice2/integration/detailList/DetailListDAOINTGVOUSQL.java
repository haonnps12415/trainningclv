...
*@FileName : DetailListDAOINTGVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DetailListDAOINTGVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DetailListDAOINTGVOUSQL(){
		setQuery();
		...
		query.append("FileName : DetailListDAOINTGVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
