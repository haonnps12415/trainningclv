...
*@FileName : DetailListDAOINTGRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DetailListDAOINTGRSQL implements ISQLTemplate{
	...
	public DetailListDAOINTGRSQL(){
		...
		query.append("FileName : DetailListDAOINTGRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
