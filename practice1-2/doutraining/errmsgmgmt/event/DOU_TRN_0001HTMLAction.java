...
public class DOU_TRN_0001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * DOU_TRN_0001HTMLAction 객체를 생성
	 */
	public DOU_TRN_0001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		DouTrn0001Event event = new DouTrn0001Event();
		ErrMsgVO comErrMsgVO  = new ErrMsgVO();
