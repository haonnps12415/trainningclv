...
*@FileName : JooCarrierMgmtDBSearchDAOCrrCdRSQL.java
...
public class JooCarrierMgmtDBSearchDAOCrrCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooCarrierMgmtDBSearchDAOCrrCdRSQL(){
		setQuery();
		...
		query.append("FileName : JooCarrierMgmtDBSearchDAOCrrCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
