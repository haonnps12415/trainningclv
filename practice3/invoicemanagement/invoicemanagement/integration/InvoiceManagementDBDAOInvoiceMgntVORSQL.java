...
*@FileName : InvoiceManagementDBDAOInvoiceMgntVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceManagementDBDAOInvoiceMgntVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceManagementDBDAOInvoiceMgntVORSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceManagementDBDAOInvoiceMgntVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
