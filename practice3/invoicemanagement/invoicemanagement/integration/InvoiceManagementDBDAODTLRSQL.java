...
*@FileName : InvoiceManagementDBDAODTLRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceManagementDBDAODTLRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceManagementDBDAODTLRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceManagementDBDAODTLRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	AND   INV.INV_NO LIKE '%'||@[inv_no]||'%'" ).append("\n"); 
