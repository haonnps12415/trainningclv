...
*@FileName : InvoiceMgmtVO.java
*@FileTitle : InvoiceMgmtVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.esm.clv.invoicemanagement.invoicemanagement.vo;
...
public class InvoiceMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InvoiceMgmtVO> models = new ArrayList<InvoiceMgmtVO>();
	...
	public InvoiceMgmtVO() {}

	public InvoiceMgmtVO(String ibflag, String pagerows, String joCrrCd, String rlaneCd, String loclCurrCd, String invNo, String csrNo, String aproFlg, String custVndrCntCd, String custVndrSeq, String prnrRefNo, String custVndrEngNm, String invRevActAmt, String invExpActAmt, String frAcctYrmon, String toAcctYrmon) {
		this.csrNo = csrNo;
...
/**
	 ...
	 * @param request
	 * @return InvoiceMgmtVO[]
	 */
	public InvoiceMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InvoiceMgmtVO[]
	 */
	public InvoiceMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InvoiceMgmtVO model = null;
	 ...
	 * @return InvoiceMgmtVO[]
	 */
	public InvoiceMgmtVO[] getInvoiceMgmtVOs(){
		InvoiceMgmtVO[] vos = (InvoiceMgmtVO[])models.toArray(new InvoiceMgmtVO[models.size()]);
		return vos;
	}
