...
public class DTLVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DTLVO> models = new ArrayList<DTLVO>();
	...
	public DTLVO(String ibflag, String pagerows, String joCrrCd, String rlaneCd, String loclCurrCd, String invNo, String csrNo, String aproFlg, String custVndrCntCd, String custVndrSeq, String prnrRefNo, String custVndrEngNm, String revExp, String item, String invRevActAmt, String invExpActAmt) {
		this.csrNo = csrNo;
...
/**
	 ...
	 * @return DTLVO[]
	 */
	public DTLVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DTLVO[]
	 */
	public DTLVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DTLVO model = null;
	...
	public DTLVO[] getDTLVOs(){
		DTLVO[] vos = (DTLVO[])models.toArray(new DTLVO[models.size()]);
		return vos;
	}
